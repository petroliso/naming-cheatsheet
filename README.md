...
```
Дополнительная информация для branch1 - коммит 1
Дополнительная информация для branch1 - коммит 2
Дополнительная информация для branch1 - коммит 3
# Дополнительная информация для branch1 - коммит 4
# Дополнительная информация для branch1 - коммит 5
# Дополнительная информация для branch1 - коммит 6
